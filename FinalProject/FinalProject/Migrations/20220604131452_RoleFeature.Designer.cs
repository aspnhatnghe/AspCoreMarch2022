...
namespace FinalProject.Migrations
{
    ...
    [Migration("20220604131452_RoleFeature")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FinalProject.Data.Feature", b =>
                {
            ...
            modelBuilder.Entity("FinalProject.Data.FeatureRole", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("FinalProject.Data.Role", b =>
                {
                    b.Property<int>("RoleId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("FinalProject.Data.UserRole", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("FinalProject.Data.FeatureRole", b =>
                {
                    b.HasOne("FinalProject.Data.Feature", "Feature")
                        .WithMany()
                        .HasForeignKey("FeatureId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("FinalProject.Data.Role", "Role")
            ...
            modelBuilder.Entity("FinalProject.Data.UserRole", b =>
                {
                    b.HasOne("FinalProject.Data.Customer", "User")
                        .WithMany("UserRoles")
                        .HasForeignKey("CustomerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
